...
$dir=$ARGV[0];
if ((! -d "$dir/sysdeps/ieee754/flt32")
 || (! -d "$dir/sysdeps/ieee754/dbl64")
 || (! -d "$dir/sysdeps/ieee754/ldbl96")
...
# Copy files
system("cp -r $dir/sysdeps/ieee754/flt32 $dir/sysdeps/ieee754/dbl64 $dir/sysdeps/ieee754/ldbl96 .");
if (! -d "headers") {mkdir("headers");}
system("cp -r $dir/math/s_ldexpf.c flt32");
system("cp -r $dir/math/s_ldexp.c $dir/math/s_nextafter.c dbl64");
# this ldbl function is actually an alias to the dbl one in the libm. Make a hard copy here.
system("cp -r $dir/math/s_ldexp.c ldbl96/s_ldexpl.c");
...
if (-r "ldbl96/printf_fphex.c") {unlink "ldbl96/printf_fphex.c";}
if (-r "ldbl96/strtold_l.c") {unlink "ldbl96/strtold_l.c";}
if (-r "flt32/mpn2flt.c") {unlink "flt32/mpn2flt.c";}
if (-r "dbl64/mpn2dbl.c") {unlink "dbl64/mpn2dbl.c";}
if (-r "dbl64/dbl2mpn.c") {unlink "dbl64/dbl2mpn.c";}
if (-r "dbl64/t_exp.c") {unlink "dbl64/t_exp.c";}
if (-r "ldbl96/mpn2ldbl.c") {unlink "ldbl96/mpn2ldbl.c";}
if (-r "ldbl96/ldbl2mpn.c") {unlink "ldbl96/ldbl2mpn.c";}
if (-r "ldbl96/s_nexttoward.c") {unlink "ldbl96/s_nexttoward.c";}
if (-r "ldbl96/s_nexttowardf.c") {unlink "ldbl96/s_nexttowardf.c";}
if (-r "ldbl96/math_ldbl.h") {unlink "ldbl96/math_ldbl.h";}
...
@filelist = glob("flt32/*.c dbl64/*.c ldbl96/*.c");
foreach $f (@filelist) {
    $g = $f;
    $g =~ s/\.c$/.cpp/;
    rename $f, $g;
...
$parentMakefile="";
foreach $dir ("flt32", "dbl64", "ldbl96") {
    ...
    print FILE "# Makefile automatically generated by import.pl\n"
              ...
              ."CPPFLAGS = $(CPPFLAGS) -I../headers -DLIBM_COMPILING_$DIR=1\n"
              ."all: @objFiles\n"
              ."\techo '$dir done!'\n";
    close FILE;
...
@projectFiles = glob("flt32/* dbl64/* ldbl96/* headers/*");

...
float32 int64_to_float32( long long a )
{
    flag zSign;
    uint64 absA;
    int8 shiftCount;
...
float64 int64_to_float64( long long a )
{
    flag zSign;
...
floatx80 int64_to_floatx80( long long a )
{
    flag zSign;
    uint64 absA;
    int8 shiftCount;
...
long long float32_to_int64( float32 a )
{
    flag aSign;
    int16 aExp, shiftCount;
    bits32 aSig;
...
long long float32_to_int64_round_to_zero( float32 a )
{
    flag aSign;
    int16 aExp, shiftCount;
    bits32 aSig;
...
long long float64_to_int64( float64 a )
{
    flag aSign;
    int16 aExp, shiftCount;
...
long long float64_to_int64_round_to_zero( float64 a )
{
    flag aSign;
    int16 aExp, shiftCount;
    bits64 aSig;
...
long long floatx80_to_int64( floatx80 a )
{
    flag aSign;
    int32 aExp, shiftCount;
    bits64 aSig, aSigExtra;
...
long long floatx80_to_int64_round_to_zero( floatx80 a )
{
    flag aSign;
    int32 aExp, shiftCount;
    bits64 aSig;
...
long long float128_to_int64( float128 a )
{
    flag aSign;
    int32 aExp, shiftCount;
    bits64 aSig0, aSig1;
...
long long float128_to_int64_round_to_zero( float128 a )
{
    flag aSign;
    int32 aExp, shiftCount;
    bits64 aSig0, aSig1;
